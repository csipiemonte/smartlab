...
/**
 * The WiFiHandler class create an interface to handle a WiFi connection. You can set a
...
class WiFiHandler
{
  ...
  public:
     ...
     *
     */
    WiFiHandler(unsigned int type, const char* ssid, const char* key = 0,
        int keyIndex = 0);
     ...
     *
     */
    WiFiHandler(const WiFiHandler& wl);
