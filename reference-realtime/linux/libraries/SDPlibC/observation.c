...
{
  //printf("valore di contValues=%d in observationAddValue\n",obs.contValues);
...
{
  //printf("valore del value da aggiungere con contComponents=%d\n",val.contComponents);
  val.components[val.contComponents] = component;
  val.contComponents++;
  //printf("valore del value al termine con contComponents=%d\n",val.contComponents);
  return val;
}
